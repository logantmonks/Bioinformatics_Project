#JFHProject.sh script to align, model, then search for desired genes in a proteome

#assume user is in "bioinformaticsProject" directory

#first need to create refrences for HSP70 and McrA
